...
st.header("Dataset")
agree=sidebar.checkbox("Show DataSet Ovetview")
if agree:
    st.dataframe(titanic_data)

#Select the embark town of the passanager and the display the dataset with this selection
...
#Select the range of the fare and then display the dataset with this selection
...
st.write(f"Number of Records With the Fare betwen {fare_min} and {fare_max}: {subset_fare.shape[0]}")
